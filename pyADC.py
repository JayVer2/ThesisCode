...
# def ADC_Scan(csv_path, duration):
...
#     csv_output_path = 'C:/Users/jgver/Documents/University/Thesis/ThesisCode/results/adc_data.csv'  # Specify the path for the CSV file
#     ADC_Scan(csv_output_path, duration=1)
